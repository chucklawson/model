...
describe('TaskMonitor', () => {
  ...
  describe('concurrent task monitors', () => {
    it('should handle multiple TaskMonitors simultaneously', async () => {
      new TaskMonitor({ name: 'Task 1', notifyAfterMs: 1000 });
      new TaskMonitor({ name: 'Task 2', notifyAfterMs: 2000 });
      new TaskMonitor({ name: 'Task 3', notifyAfterMs: 3000 });
    ...
    it('should handle one monitor completing while others continue', async () => {
      ...
      new TaskMonitor({ name: 'Task 2', notifyAfterMs: 5000 });
