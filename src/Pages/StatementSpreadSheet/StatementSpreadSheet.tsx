...
import StatementInput from '../../Components/SatementInput/StatementInput';
...
const StatementSpreadSheet = () =>{
    ...
    const [statmentAnalysisKeyMetrics,setStatmentAnalysisKeyMetrics] = useState<StatementAnalysisKeyMetricsData[]>([]);
...
return (
    ...
    <div className='col-start-1 col-span-12'>
            <header className="bg-lime-100 text-lime-600 text-xl font-bold h-10 justify-items-center p-1">
                <div>
                    {headerValue}
                </div> 
            </header>        
