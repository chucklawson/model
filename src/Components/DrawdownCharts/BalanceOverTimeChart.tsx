...
export default function BalanceOverTimeChart({
  ...
  // Custom tooltip
  const CustomTooltip = ({ active, payload }: { active?: boolean; payload?: Array<{ payload: { label: string; balance: number; percentRemaining: number; cumulativeInterest: number; cumulativeDrawdowns: number } }> }) => {
