// ============================================
// FILE: src/Components/YTDPerformanceModal/YTDAllocationPieChart.tsx
// YTD Portfolio Allocation Donut Chart
// ============================================
...
interface YTDAllocationPieChartProps {
...
export default function YTDAllocationPieChart({ ytdData, onTickerClick }: YTDAllocationPieChartProps) {
  const chartData = useMemo(() => {
    return ytdData.tickers.map(ticker => ({
      name: ticker.ticker,
