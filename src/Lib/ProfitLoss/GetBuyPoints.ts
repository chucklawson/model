...
export class GetBuyPoints {
  ...
  CalculateBuyPoints(highOverLastTwelveMonths: number, setTheBuyPoints: SetBuyPoints): void {
  ...
  /*
        ...
        baseYield: '5.74',
        */
   calculateProjectedYield(tickersToEvaluate: TickersToEvaluate[]): AccumulatedValues {
